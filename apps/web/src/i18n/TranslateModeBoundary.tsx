...
import { setTranslateMode } from './translateModeState'
 ...
 * page whose Try Again re-throws the cached rejection. The switch also
 * persists per browser, so every reload would fail the same way.
 *
 * This boundary turns the switch OFF, says so once, and renders nothing:
